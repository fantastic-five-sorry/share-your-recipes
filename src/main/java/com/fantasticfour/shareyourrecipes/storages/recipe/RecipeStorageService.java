...
@Qualifier("recipe")
@Primary
public class RecipeStorageService implements StorageService {

    final private Path rootLocation;

    @Autowired
    public RecipeStorageService(StorageProperties properties) {
        this.rootLocation = Paths.get(properties.getLocation() + "/recipes");
    }
