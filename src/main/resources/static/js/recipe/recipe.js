...
const recipeId = $("meta[name='recipeId']").attr('content');

// var getMoreCommentsUrl = `/api/comment/recipe/1000?size=${size}&page=${currentPage}`;
...
function template(comment) {
  return `<div class='commented-section mt-2'>
    <div class='d-flex flex-row align-items-ceRenter commented-user'>
      <h5 class='mr-2'>${comment.writerName}</h5>
      <span class='dot mb-1'></span>
      <span class='mb-1 ml-2'>${timeSince(comment.createdAt)}</span>
    </div>
